...
reservation_list[9].reference = 10;
...
Entrez le prénom: 
  ...
  //////////////////////////////////////////////////////////reference >>>>>>>>>>>>>>>>
  int Last_Index = nombre_reservation ;// find now index
  Last_Index = Last_Index - 1; // find last index

  int New_ID = reservation_list[Last_Index].reference  ;
  New_ID = New_ID + 1 ; // update las reference
   printf("votre reference est  : %d", New_ID ); // afficher new reference
   printf("\n");
   
   reservation_list[nombre_reservation].reference = New_ID ;// stocker new reference
