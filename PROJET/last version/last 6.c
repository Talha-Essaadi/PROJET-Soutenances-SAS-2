...
***************************************
recherche par nom case 4 : no
recherche par nom statut 4 : yes
********************************************
recherche par ID est le nom case 5 : yes
...
void FakeData()
{
    ...
    */
    ...
    strcpy(reservation_list[7].name, "Hind");
...
void RechercheCase_6()
{
    ...
    */
    ...
    for (int i = 0; i < nombre_reservation; i++)
    {
        if (strcmp(reservation_list[i].statut, "valide") == 0)
        { // Trucking_valide
            Trucking_valide++;

        } /////if

        else if (strcmp(reservation_list[i].statut, "reporte") == 0)
        { // Trucking_reporte
            Trucking_reporte++;

        } /////if

        else if (strcmp(reservation_list[i].statut, "annule") == 0)
        { // Trucking_annule
            Trucking_annule++;

        } /////if
        else if (strcmp(reservation_list[i].statut, "traite") == 0)
        { // Trucking_traite
            Trucking_traite++;
        }
    }
...
void Recherche_Case_5()
{
    ...
    case 1:
        ...
        break;
    case 2:
        printf("Entrer case 2 dans case 5 (int main)");
        Recherche_nom();
        printf("\n number 2 case 5");
        break;
...
void Recherche_statut_case_4_case2()
{
    FakeData();
    char statut[50];
