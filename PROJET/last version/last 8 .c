...
void supprime_reservation() {
   ...
   if(Traking!= -1){
        for ( int j = Traking ; j < nombre_reservation -1 ; j++){
               reservation_list[j] = reservation_list[j+1];
         }
         nombre_reservation = nombre_reservation - 1;
    }else{
