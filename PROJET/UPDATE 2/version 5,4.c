...
/*
recherche on case : 3
affichache tous les reservation dans case : 10
...
Réservation modifiée avec succès.
   ...
   printf("Entrez la nouvelle date de réservation (dd-mm-yyyy): \n");*/
    ...
    printf("Entrez le nouveau nom:"); 
   scanf("%s", &reservation_list[10].name);
   printf("%s\n", reservation_list[10].name);
   
    printf("Entrez le nouveau prénom: ");
   scanf("%s", &reservation_list[10].prenom);
   printf("%s\n", reservation_list[10].prenom);

   printf("Entrez le nouveau téléphone:"); 
   scanf("%d", &reservation_list[10].numero);
   printf("%d\n", reservation_list[10].numero);

   printf("Entrez le nouvel âge: "); 
   scanf("%d", &reservation_list[10].age);
   printf("%d\n", reservation_list[10].age);
   
   printf("Entrez le le nouveau statut (valide, reporte, annule, traite) : "); 
   scanf("%s", &reservation_list[10].statut);
   printf("%s\n", reservation_list[10].statut);
   
   printf("Entrez la nouvelle date de reservation JJ-MM-AAAA : "); 
   scanf("%d-%d-%d",&reservation_list[10].jour ,&reservation_list[10].mois ,&reservation_list[10].annee );
   printf("%d-%d-%d\n",reservation_list[10].jour ,reservation_list[10].mois ,reservation_list[10].annee );
