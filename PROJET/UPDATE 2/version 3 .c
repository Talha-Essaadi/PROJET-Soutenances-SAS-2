// edit 1 pour version 1
// affichage from case 3 to case 10 <<<<<<<<<<<<<<<<*************************************

// cette version 10 dans Dossier UPDATE 1

/*
Choisissez une option: 3
Entrez la référence de la réservation: REF-4282
...
Âge: 34
Statut: ggh
Date de réservation: 4545

else if :
Choisissez une option: 3
Entrez la référence de la réservation: hghg
