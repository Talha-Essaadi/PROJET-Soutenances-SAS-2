...
*/
 // Reservation 1 :  
reservation_list[0].name = "Ali";
reservation_list[0].prenom = "Al-Zahrani";
reservation_list[0].numero = 0501234567;
reservation_list[0].age = 28;
reservation_list[0].statut = "valide";   
reservation_list[0].jour = 01;
reservation_list[0].mois = 09;
reservation_list[0].annee = 2024;

 // Reservation 2 :  
reservation_list[1].name = "Sarah";
reservation_list[1].prenom = "Al-Ansari";
reservation_list[1].numero = 0562345678;
reservation_list[1].age = 34;
reservation_list[1].statut = "valide";    
reservation_list[1].jour = 15;
reservation_list[1].mois = 08;
reservation_list[1].annee = 2024;

 // Reservation 3 :  
reservation_list[2].name = "Youssef";
reservation_list[2].prenom = "Al-Badr";
reservation_list[2].numero = 0539876543;
reservation_list[2].age = 22;
reservation_list[2].statut = "valide";    
...
reservation_list[3].numero = 0551122334;
reservation_list[3].age = 30;
reservation_list[3].statut = "valide";    
...
reservation_list[4].numero = 0598765432;
reservation_list[4].age = 40;
reservation_list[4].statut = "valide";    
...
reservation_list[5].numero = 0512349876;
reservation_list[5].age = 26;
reservation_list[5].statut = "valide";     
...
reservation_list[6].numero = 0545647382;
reservation_list[6].age = 45;
reservation_list[6].statut = "valide";    
reservation_list[6].jour = 09;
...
reservation_list[7].numero = 0523498712;
reservation_list[7].age = 33;
reservation_list[7].statut = "valide";    
...
reservation_list[8].numero = 0582736451;
reservation_list[8].age = 29;
reservation_list[8].statut = "valide";   
...
reservation_list[9].numero = 0572364512;
reservation_list[9].age = 38;
reservation_list[9].statut = "valide";     
