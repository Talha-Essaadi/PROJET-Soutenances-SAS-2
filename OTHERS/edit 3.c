...
//// case 3 >>>>
void affichage () {
    int loop_reservation = nombre_reservation - 9 ;
    //////////////////////
     // Reservation 1 :  
 printf("\nReservation 1 :\n");
 strcpy(reservation_list[0].name,"Ali");
