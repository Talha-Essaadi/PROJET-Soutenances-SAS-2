...
////////////////////////^^^^CASE 1 ^^^///////////////////////////////
//// case 3 >>>>
void affichage_reservations () {
    printf("le nom : "); 
   printf("%s",  reservation_list[affichage].name);
   printf("le prenom : "); 
   printf("%s", reservation_list[affichage].prenom);
   printf("le numero de telephone : "); 
   printf("%s", reservation_list[affichage].numero);
   printf("l'age : "); 
   printf("%s", reservation_list[affichage].age);
   printf("le statut est : "); 
   printf("%s", reservation_list[affichage].statut);
   
   printf("la date de reservation JJ-MM-AAAA est : "); 
   printf("%d-%d-%d",reservation_list[affichage].jour ,reservation_list[affichage].mois ,reservation_list[affichage].annee );
