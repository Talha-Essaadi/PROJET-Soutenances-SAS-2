...
Réservation modifiée avec succès.
   ...
   printf("Entrez la nouvelle date de réservation (dd-mm-yyyy): \n");*/
    ...
    printf("Entrez le nouveau nom:"); 
   scanf("%s", &reservation_list[9].name);
   printf("%s\n", reservation_list[9].name);
   
    printf("Entrez le nouveau prénom: ");
   scanf("%s", &reservation_list[9].prenom);
   printf("%s\n", reservation_list[9].prenom);

   printf("Entrez le nouveau téléphone:"); 
   scanf("%d", &reservation_list[9].numero);
   printf("%d\n", reservation_list[9].numero);

   printf("Entrez le nouvel âge: "); 
   scanf("%d", &reservation_list[9].age);
   printf("%d\n", reservation_list[9].age);
   
   printf("Entrez le le nouveau statut (valide, reporte, annule, traite) : "); 
   scanf("%s", &reservation_list[9].statut);
   printf("%s\n", reservation_list[9].statut);
   
   printf("Entrez la nouvelle date de reservation JJ-MM-AAAA : "); 
   scanf("%d-%d-%d",&reservation_list[9].jour ,&reservation_list[9].mois ,&reservation_list[9].annee );
   printf("%d-%d-%d\n",reservation_list[9].jour ,reservation_list[9].mois ,reservation_list[9].annee );
